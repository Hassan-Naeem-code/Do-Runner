...
import {font_black, font_secondary, primary, secondary, white} from '../../Utils/colors';
  ...
  return (
    <SafeAreaView>
      ...
      <ScrollView contentContainerStyle={{paddingVertical:10}}>
              <Text style={{fontFamily:medium,fontSize:font4,textAlign:'center'}}>Dett finns inga kopta uppdrag</Text>
        </ScrollView>
    </>:
