...
const Installning = props => {
  ...
  return (
    <ScrollView
      ...
      <View style={{}}>
        <Text style={{fontSize: font4, marginBottom: 10,color: font_black}}>EMAIL</Text>
        <Textinput
          type={'normal'}
      ...
      <View style={{marginVertical: 30}}>
        ...
        <View style={[styles.installingCheckRow, {marginTop: 10}]}>
          ...
          <View style={{flex: 0.9}}>
            <Text style={styles.installingCheckTxt}>
              Notifiering via SMS for osalda uppdrag
            </Text>
          </View>
        </View>
        <Text style={[styles.installingCheckTxt, {fontSize: font3}]}>
          Osalda uppdragg ger okad chans till after da uppdragsgivaren saknar
          offerter. Dessutom har antalet platser reducerats till 3.
        </Text>
      </View>
      ...
      <View
        ...
        <Text style={{fontSize: font4, fontFamily: medium,color: font_black}}>
          Du kan avaktivera din profit .ex nar du gar semester sa att du inte
          far matchningsmall och sms.
        </Text>
      </View>
