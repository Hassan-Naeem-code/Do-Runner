    ...
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={{padding: 20, marginTop: 20}}>
        <Text style={{fontFamily: medium, fontSize: font4, color: font_black}}>
          {' '}
          Invite Your Industry Colleagues, get 5 Coupons
        </Text>
        <View style={{flexDirection: 'row', marginVertical: 20}}>
          ...
          <View style={{flex: 0.88, paddingHorizontal: 5, marginTop: 5}}>
            <Text
              ...
              {' '}
              Your Colleagues, will recieve 5 coupons
            </Text>
            <Text
              style={{fontFamily: medium, fontSize: font3, color: font_black}}>
              {' '}
              Your Colleagues, will recieve 5 coupons
            </Text>
          </View>
        ...
        <View style={{flexDirection: 'row', marginVertical: 20}}>
          ...
          <View style={{flex: 0.88, paddingHorizontal: 5, marginTop: 5}}>
            <Text
              ...
              {' '}
              Your will get 5 coupons
            </Text>
            <Text
              style={{fontFamily: medium, fontSize: font3, color: font_black}}>
              {' '}
              When your colleague registers and 3 more coupons when they make
        ...
        <View style={{marginTop: 30, position: 'relative'}}>
          ...
          <Textinput
            ...
            borderRadius={25}
            id_editable={true}
            value={referralsData !== null && referralsData?.url}
          />
          <TouchableHighlight
